"""SQLAlchemy models for the retail taxonomy hierarchy."""
...
class Department(Base):
    ...
    __table_args__ = (UniqueConstraint("zone_id", "name", name="uq_departments_zone_id_name"),)
...
class Category(Base):
    ...
    __table_args__ = (
        UniqueConstraint("department_id", "name", name="uq_categories_department_id_name"),
    )
...
class Subcategory(Base):
    ...
    __table_args__ = (
        UniqueConstraint("category_id", "name", name="uq_subcategories_category_id_name"),
    )
